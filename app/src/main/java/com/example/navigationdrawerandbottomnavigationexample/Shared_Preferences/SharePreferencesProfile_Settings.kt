...
import com.example.navigationdrawerandbottomnavigationexample.databinding.ActivityProfileShareprefrencesSettingsBinding
/*import com.example.shareprefrencesexample.databinding.ActivityProfileSettingsBinding*/

class SharePreferencesProfile_Settings : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.newButton1.setOnClickListener {
            ...
            startActivity(Intent(this, SharePreferencesMainActivity::class.java))
        }
