package com.example.navigationdrawerandbottomnavigationexample.Task_15_Motion_Layout.Task_8_Whatsapp_Status_Saver
...
import com.example.navigationdrawerandbottomnavigationexample.databinding.WhatsappViewBinding
...
class StatusAdapter(private val uriStringList: ArrayList<String>, private val activity: Activity) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        var bindingView = WhatsappViewBinding.inflate(LayoutInflater.from(activity),parent,false)
    ...
    class ViewHolder(var binding: WhatsappViewBinding) : RecyclerView.ViewHolder(binding.root) {
