...
import com.example.navigationdrawerandbottomnavigationexample.databinding.ActivitySignupBinding
...
class SignupActivity : AppCompatActivity() {
    ...
    private fun writeData(){
        ...
        if(firstName.isNotEmpty() && lastName.isNotEmpty() && yourPassword.isNotEmpty() && yourAge.isNotEmpty()){
            //val student= Student(null,firstName,lastName,yourPassword,yourAge.toInt(), null, null, null)
            val student= Student(null,firstName,lastName,yourPassword,yourAge.toInt())
